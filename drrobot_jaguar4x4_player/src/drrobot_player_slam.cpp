...
//======================================================================
    ...
    DrRobotPlayerNode()
    {
	  ...
	  strcpy(robotConfig2_.serialPortName,robotSerialPort_.c_str());
		...
		odom_pub_ = node_.advertise<nav_msgs::Odometry>("odom", 10);
		Rscanpose_publisher= node_.advertise<drrobot_jaguar4x4_player::Rscanpose>("Rscanpose", 10);//added to save scan plus encorder for EKF offline
		path_pub_ = node_.advertise<nav_msgs::Path>("path", 10);
		variable_publisher = node_.advertise<drrobot_jaguar4x4_player::variable>("variable", 10);//added
		encorder_publisher = node_.advertise<std_msgs::Int32MultiArray>("encorder", 10);//added
		KFodom_publisher = node_.advertise<drrobot_jaguar4x4_player::KFodom>("KFodom", 10);//added	
...
//======================================================================
	...
	else
	{
     ...
     slam_pose_sub= node_.subscribe<geometry_msgs::Pose2D>("slam_pose", 1, boost::bind(&DrRobotPlayerNode::get_updated_pose, this, _1));
...
//======================================================================
void get_updated_pose(const geometry_msgs::Pose2D::ConstPtr& msg){ // from updated parameter function()
...
{			
	...
	//x_1			= x; // assgned privious value from slam_pose
	//y_1			= y;
	//theta_1		= theta;
