...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_6f3B().pack(_x.bat1_vol, _x.bat2_vol, _x.bat1_temp, _x.bat2_temp, _x.dcin_vol, _x.ref_vol, _x.power_status, _x.power_path, _x.charge_path))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.bat1_vol, _x.bat2_vol, _x.bat1_temp, _x.bat2_temp, _x.dcin_vol, _x.ref_vol, _x.power_status, _x.power_path, _x.charge_path,) = _get_struct_6f3B().unpack(str[start:end])
      return self
