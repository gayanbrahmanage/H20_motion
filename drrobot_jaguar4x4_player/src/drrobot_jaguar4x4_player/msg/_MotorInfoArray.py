  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.motorInfos:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
        _x = val1
        buff.write(_get_struct_3IfI().pack(_x.encoder_pos, _x.encoder_vel, _x.encoder_dir, _x.motor_current, _x.motor_pwm))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_x.encoder_pos, _x.encoder_vel, _x.encoder_dir, _x.motor_current, _x.motor_pwm,) = _get_struct_3IfI().unpack(str[start:end])
...
def _get_struct_2I():
    ...
    return _struct_2I
_struct_3IfI = None
def _get_struct_3IfI():
    global _struct_3IfI
    if _struct_3IfI is None:
