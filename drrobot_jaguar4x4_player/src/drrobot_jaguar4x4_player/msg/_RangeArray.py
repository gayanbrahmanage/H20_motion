...
"""autogenerated by genpy from drrobot_jaguar4x4_player/RangeArray.msg. Do not edit."""
import sys
...
class RangeArray(genpy.Message):
  ...
  _type = "drrobot_jaguar4x4_player/RangeArray"
...
"""
  __slots__ = ['ranges']
  _slot_types = ['drrobot_jaguar4x4_player/Range[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = drrobot_jaguar4x4_player.msg.Range()
        _v3 = val1.header
        start = end
        end += 4
