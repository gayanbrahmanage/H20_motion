...
(defsystem "drrobot_jaguar4x4_player-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "KFodom" :depends-on ("_package_KFodom"))
    (:file "_package_KFodom" :depends-on ("_package"))
    ...
    (:file "Rscanpose" :depends-on ("_package_Rscanpose"))
    (:file "_package_Rscanpose" :depends-on ("_package"))
    (:file "variable" :depends-on ("_package_variable"))
    (:file "_package_variable" :depends-on ("_package"))
  ))